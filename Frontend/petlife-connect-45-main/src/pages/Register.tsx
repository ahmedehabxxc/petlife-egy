...
=======
          ...
          bio: bio || undefined,
          profilePhotoBase64,
          profilePhotoFileName: profilePhoto?.name ?? null,
          profilePhotoContentType: profilePhoto?.type ?? null,
>>>>>>> 566e763e4723dcdbb86bc931af1d7ad2ab712daf
                ...
                {isVet && (
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="phone" type="tel" placeholder="e.g. 01012345678" value={phone} onChange={(e) => setPhone(e.target.value)} className="h-11" />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-3">
                        {profilePhotoPreview ? (
                          <img src={profilePhotoPreview} alt="Profile preview" className="h-14 w-14 rounded-full object-cover border" />
                        ) : (
                          <div className="h-14 w-14 rounded-full bg-muted flex items-center justify-center text-xs text-muted-foreground">Photo</div>
                        )}
                        <Input
                          type="file"
                          accept="image/*"
