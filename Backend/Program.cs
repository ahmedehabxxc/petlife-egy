...
=======
            ...
            builder.Services.AddSingleton<VetCredentialPersistence>();
            builder.Services.AddSingleton<VetAuthMetadataService>();
            builder.Services.AddSingleton<SupabaseVetProfileStore>();
            // --- 2. BUILD THE APP ---
            var app = builder.Build();
